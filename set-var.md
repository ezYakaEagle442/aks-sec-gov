...
aks_private_dns_link_name="prv-lnk-aks-bastion-${appName,,}"
echo "AKS private-dns link Name :" $aks_private_dns_link_name
...
kv_private_endpoint_svc_con_name="prv-ep-kv-${appName,,}-svc-con"
echo "KeyVault private-endpoint Service Connection :" $kv_private_endpoint_svc_con_name
